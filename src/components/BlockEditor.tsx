				...
				<div key={block.id} class="rounded-md border border-ctp-surface0 bg-ctp-crust p-2">
					<div class="flex items-center gap-2">
						<input
							...
							value={block.label}
							placeholder="小标题（可留空）"
							class="min-w-0 flex-1 rounded border-none bg-transparent px-2 py-1.5 text-sm font-medium text-ctp-mauve placeholder:text-ctp-overlay0 focus:outline-none"
					...
					<textarea
						...
						class="mt-1 w-full resize-y rounded border-none bg-transparent px-2 py-1.5 text-sm leading-relaxed text-ctp-text placeholder:text-ctp-overlay0 focus:outline-none"
