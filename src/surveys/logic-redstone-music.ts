 ...
 * - 五道单选题都写了 `default`，所以一进问卷就是「JE 1.14+ & BE 1.13.0+ / 单调（无分歧）/
 *   无要求 / 无差异 / 禁止」，想换就点别的选项，或点「自定义」自己写一句；
 *   再点一下已选中的项就取消，那一行也就不印
 * - 「适用版本」的预填取**最低那一档**（JE 1.14+ & BE 1.13.0+）：原来的「通用」不在选项里了，
 *   这一档语义上最接近它——「从最早那版起都行」
...
export const logicRedstoneMusicSurvey: Survey = {
	...
	questions: [
		...
		},
		{
			...
			label: '适用版本',
			kind: 'choice',
			options: ['JE 1.14+ & BE 1.13.0+', 'JE 1.21+ & BE 1.21.0+', 'JE 26.1+ & BE 26.10+'],
			default: 'JE 1.14+ & BE 1.13.0+',
		},
		{
			into: 'meta',
			id: 'stateSpace',
